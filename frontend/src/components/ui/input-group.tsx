    ...
    <div
      ...
      className={cn(
        `
          ...
          rounded-md border border-(--input-border) outline-none

          in-data-[slot=combobox-content]:focus-within:border-inherit
          in-data-[slot=combobox-content]:focus-within:ring-0
          
          has-[[data-slot][aria-invalid=true]]:border-destructive has-[[data-slot][aria-invalid=true]]:ring-3
...
const inputGroupAddonVariants = cva(
  ...
  group-data-[state=active]/input-group:text-(--brand-base)
  group-data-[state=filled]/input-group:text-(--input-color)
  group-data-[state=error]/input-group:text-(--danger)
  group-data-[disabled=true]/input-group:text-(--black)
